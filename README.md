...
5. Add inherited permission for Domain Computers on the folder where you store your logs to able the computers creates or removes folders and writes logs
